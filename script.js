...
// Firezone first visit authorization popup
document.addEventListener("DOMContentLoaded", () => {
  if (!localStorage.getItem("firezone_auth_closed")) {
    const box = document.createElement("div");
    box.className = "auth-popup";
    box.innerHTML = `
    ...
    box.querySelector(".auth-close").onclick = () => {
      localStorage.setItem("firezone_auth_closed","1");
      box.remove();
    };
  }
});
